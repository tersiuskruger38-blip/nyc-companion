export const initialActivities = {
  ...
  1: {
    ...
    afternoon: [
      ...
      { id: "1a4", name: "King Dumplings", category: "food", time: "16:00", price: "$", duration: "30 min", description: "Handmade dumplings, $3.50 for a massive portion. Quick afternoon snack before hotel rest.", address: "19 Allen St, New York, NY 10002", notes: "Cash only! 5 min walk from hotel. Grab a quick bite on the way back.", status: "upcoming", starred: true, bookingUrl: "", comment: "" },
      { id: "1a5", name: "Rest at Hotel", category: "hotel", time: "16:45", price: "free", duration: "90 min", description: "Head back to LES. Rest your feet, shower, recharge before dinner.", address: "77 Ludlow St, New York, NY 10002", notes: "F train from York St (DUMBO) to Delancey St. Don't skip this!", status: "upcoming", starred: false, bookingUrl: "", comment: "" },
    ],
    evening: [
      { id: "1e1", name: "Explore Nolita & Little Italy", category: "walk", time: "19:00", price: "free", duration: "45 min", description: "Pre-dinner stroll through Nolita's boutique-lined streets and Little Italy's Mulberry St. Soak in the atmosphere before your fancy dinner.", address: "Nolita / Little Italy, Manhattan", notes: "Walk down Mott St and Elizabeth St. Great window shopping. Ends right at the restaurant.", status: "upcoming", starred: false, bookingUrl: "", comment: "" },
